...
class SiniestroController:
    def __init__(self,siniestro_model,cliente_model,vehiculo_model,siniestros_view):
       
        self.siniestro_model = siniestro_model
        self.cliente_model = cliente_model
        self.vehiculo_model = vehiculo_model
        self.siniestros_view = siniestros_view
    ...
    def mostrar_siniestros(self):
            ...
            try:
                ...
                if not siniestros:  # Si no hay siniestros
                    ...
                    self.siniestros_view.actualizar_siniestro(siniestros)
